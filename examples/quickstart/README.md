# Mnemic Quickstart Example

This example demonstrates the basic functionality of Mnemic, including:

1. Connecting to a Neo4j or FalkorDB database
2. Initializing Mnemic indices and constraints
...
- **Graph Initialization**: Setting up the Mnemic indices and constraints in Neo4j, Amazon Neptune, or FalkorDB
...
4. Try other predefined search recipes from `mnemic.search.search_config_recipes`

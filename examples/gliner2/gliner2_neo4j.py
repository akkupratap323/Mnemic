...
from mnemic.embedder.gemini import GeminiEmbedder, GeminiEmbedderConfig
from mnemic.llm_client.config import LLMConfig
from mnemic.llm_client.gemini_client import GeminiClient
from mnemic.llm_client.gliner2_client import GLiNER2Client
...
async def main():
    ...
    # Initialize Mnemic with the GLiNER2 hybrid client and Gemini embedder
    mnemic = Mnemic(
        neo4j_uri,
        neo4j_user,
        neo4j_password,

...
The FastAPI server container is automatically built and published to Docker Hub when a new `mnemic` version is released to PyPI.

**Image:** `mnemic/mnemic`

**Available tags:**
- `latest` - Latest stable release
- `0.22.1` - Specific version (matches mnemic version)

**Platforms:** linux/amd64, linux/arm64

The automated release workflow:
1. Triggers when `mnemic` PyPI release completes
...
2. Add `mnemic/mnemic:latest` to your service setup

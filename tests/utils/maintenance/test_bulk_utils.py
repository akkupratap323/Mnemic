...
from mnemic.utils import bulk_utils
from mnemic.utils.bulk_utils import extract_nodes_and_edges_bulk
...
def _make_clients() -> MnemicClients:
    driver = MagicMock()
    embedder = MagicMock()
    cross_encoder = MagicMock()
    llm_client = MagicMock()

    return MnemicClients.model_construct(  # bypass validation to allow test doubles
        driver=driver,
        embedder=embedder,

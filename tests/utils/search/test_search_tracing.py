...
from mnemic.search.search import edge_search, search
from mnemic.search.search_config import EdgeSearchConfig, EdgeSearchMethod, SearchConfig
...
async def test_search_emits_trace_spans_for_edge_similarity(monkeypatch):
    ...
    monkeypatch.setattr(
        'mnemic.search.search.edge_similarity_search',

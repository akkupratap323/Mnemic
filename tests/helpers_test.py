...
from mnemic.edges import EntityEdge, EpisodicEdge
from mnemic.embedder.client import EmbedderClient
from mnemic.helpers import lucene_sanitize
...
group_id = 'mnemic_test_group'
group_id_2 = 'mnemic_test_group_2'

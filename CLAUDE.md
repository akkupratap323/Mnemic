...
Mnemic is a Python framework for building temporally-aware knowledge graphs designed for AI agents. It enables real-time incremental updates to knowledge graphs without batch recomputation, making it suitable for dynamic environments.
...
- **Main Entry Point**: `mnemic.py` - Contains the main `Mnemic` class that orchestrates all functionality
...
- **MCP Implementation**: `mnemic_mcp_server.py` - Model Context Protocol server for AI assistants

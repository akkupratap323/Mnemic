#!/usr/bin/env python3
"""
FalkorDB integration test for the Mnemic MCP Server.
...
class MnemicFalkorDBIntegrationTest:
    """Integration test client for Mnemic MCP Server using FalkorDB backend."""
    ...
    async def __aenter__(self):
        ...
        server_params = StdioServerParameters(
            ...
            env={
                ...
                'MNEMIC_GROUP_ID': self.test_group_id,
            },
        )
    ...
    async def test_add_episode(self) -> bool:
        ...
        result = await self.call_mcp_tool('remember', episode_data)
...
async def run_falkordb_integration_test() -> bool:
    ...
    try:
        async with MnemicFalkorDBIntegrationTest() as test_client:

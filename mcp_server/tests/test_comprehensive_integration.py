#!/usr/bin/env python3
"""
Comprehensive integration test suite for Mnemic MCP Server.
...
class MnemicTestClient:
    """Enhanced test client for comprehensive Mnemic MCP testing."""
    ...
    async def __aenter__(self):
        ...
        server_params = StdioServerParameters(
            ...
            env={
                ...
                'NEO4J_PASSWORD': os.environ.get('NEO4J_PASSWORD', 'mnemic'),
...
class TestCoreOperations:
    """Test core Mnemic operations."""

    @pytest.mark.asyncio
    async def test_server_initialization(self):
        """Verify server initializes with all required tools."""
        async with MnemicTestClient() as client:
    ...
    async def test_add_message_memory(self):
        ...
        async with MnemicTestClient() as client:
            conversation = """
            user: What are the key features of Mnemic?
            assistant: Mnemic offers temporal-aware knowledge graphs, hybrid retrieval, and real-time updates.
...
def generate_test_report(client: MnemicTestClient) -> str:
    ...
    report = []
    report.append('\n' + '=' * 60)
    report.append('MNEMIC MCP TEST REPORT')
    report.append('=' * 60)

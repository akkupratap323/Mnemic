#!/usr/bin/env python3
"""
Main entry point for Mnemic MCP Server

This is a backwards-compatible wrapper around the original mnemic_mcp_server.py
...
if __name__ == '__main__':
    from mnemic_mcp_server import main

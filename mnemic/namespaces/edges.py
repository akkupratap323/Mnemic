...
class EntityEdgeNamespace:
    """Namespace for entity edge operations. Accessed as ``mnemic.edges.entity``."""
...
class EpisodicEdgeNamespace:
    """Namespace for episodic edge operations. Accessed as ``mnemic.edges.episodic``."""
...
class CommunityEdgeNamespace:
    """Namespace for community edge operations. Accessed as ``mnemic.edges.community``."""
...
class HasEpisodeEdgeNamespace:
    """Namespace for has_episode edge operations. Accessed as ``mnemic.edges.has_episode``."""
...
class NextEpisodeEdgeNamespace:
    """Namespace for next_episode edge operations. Accessed as ``mnemic.edges.next_episode``."""
...
class EdgeNamespace:
    """Namespace for all edge operations. Accessed as ``mnemic.edges``.

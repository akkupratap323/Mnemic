...
from mnemic.nodes import CommunityNode, EntityNode, EpisodicNode, SagaNode


class EntityNodeNamespace:
    """Namespace for entity node operations. Accessed as ``mnemic.nodes.entity``."""
...
class EpisodeNodeNamespace:
    """Namespace for episode node operations. Accessed as ``mnemic.nodes.episode``."""
    ...
    async def recent_episodes(
        ...
        return await self._ops.recent_episodes(
            self._driver, reference_time, last_n, group_ids, source, saga
        )


class CommunityNodeNamespace:
    """Namespace for community node operations. Accessed as ``mnemic.nodes.community``."""
...
class SagaNodeNamespace:
    """Namespace for saga node operations. Accessed as ``mnemic.nodes.saga``."""
...
class NodeNamespace:
    """Namespace for all node operations. Accessed as ``mnemic.nodes``.

...
if TYPE_CHECKING:
    ...
    try:
        ...
        raise ImportError(
            ...
            'Install it with: pip install mnemic[falkordb]'
        ) from None

from mnemic.driver.driver import GraphDriver, GraphDriverSession, GraphProvider
from mnemic.driver.falkordb import STOPWORDS as STOPWORDS
from mnemic.driver.falkordb.operations.community_edge_ops import (
    FalkorCommunityEdgeOperations,
)
from mnemic.driver.falkordb.operations.community_node_ops import (
    FalkorCommunityNodeOperations,
)
from mnemic.driver.falkordb.operations.entity_edge_ops import FalkorEntityEdgeOperations
from mnemic.driver.falkordb.operations.entity_node_ops import FalkorEntityNodeOperations
from mnemic.driver.falkordb.operations.episode_node_ops import FalkorEpisodeNodeOperations
from mnemic.driver.falkordb.operations.episodic_edge_ops import FalkorEpisodicEdgeOperations
from mnemic.driver.falkordb.operations.graph_ops import FalkorGraphMaintenanceOperations
from mnemic.driver.falkordb.operations.has_episode_edge_ops import (
    FalkorHasEpisodeEdgeOperations,
)
from mnemic.driver.falkordb.operations.next_episode_edge_ops import (
    FalkorNextEpisodeEdgeOperations,
)
from mnemic.driver.falkordb.operations.saga_node_ops import FalkorSagaNodeOperations
from mnemic.driver.falkordb.operations.search_ops import FalkorSearchOperations
...
from mnemic.graph_queries import get_fulltext_indices, get_range_indices
from mnemic.helpers import validate_group_ids
from mnemic.utils.datetime_utils import convert_datetimes_to_strings
...
class FalkorDriver(GraphDriver):
    ...
    async def execute_query(self, cypher_query_, **kwargs: Any):
        ...
        # Convert FalkorDB's result format (list of lists) to the format expected by Mnemic (list of dicts)
        records = []

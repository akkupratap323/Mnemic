...
# default globally via the MNEMIC_ATTRIBUTE_MAX_LENGTH env var.
...
_ENV_VAR = 'MNEMIC_ATTRIBUTE_MAX_LENGTH'
...
def cap_string_attributes(
    ...
    *,
    ...
    the resolved default (``MNEMIC_ATTRIBUTE_MAX_LENGTH`` env var if set, else
